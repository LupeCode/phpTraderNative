...
class TraderFriendly
{
     ...
     * @throws \Exception
     */
    public static function absolutePriceOscillator(array $real, int $fastPeriod = 12, int $slowPeriod = 26, MovingAverageType $mAType = MovingAverageType::SMA): array
    {
     ...
     * @throws \Exception
     */
    public static function bollingerBands(array $real, int $timePeriod = 5, float $nbDevUp = 2.0, float $nbDevDn = 2.0, MovingAverageType $mAType = MovingAverageType::SMA): array
    {
     ...
     * @throws \Exception
     */
    public static function movingAverage(array $real, int $timePeriod = 30, MovingAverageType $mAType = MovingAverageType::SMA): array
    {
     ...
     * @throws \Exception
     */
    public static function movingAverageVariablePeriod(array $real, array $periods, int $minPeriod = 2, int $maxPeriod = 30, MovingAverageType $mAType = MovingAverageType::SMA): array
    {
     ...
     * @throws \Exception
     */
    public static function percentagePriceOscillator(array $real, int $fastPeriod = 12, int $slowPeriod = 26, MovingAverageType $mAType = MovingAverageType::SMA): array
    {
     ...
     * @throws \Exception
     */
    public static function stochasticFast(array $high, array $low, array $close, int $fastK_Period = 5, int $fastD_Period = 3, MovingAverageType $fastD_MAType = MovingAverageType::SMA): array
    {
     ...
     * @throws \Exception
     */
    public static function stochasticRelativeStrengthIndex(array $real, int $timePeriod = 14, int $fastK_Period = 5, int $fastD_Period = 3, MovingAverageType $fastD_MAType = MovingAverageType::SMA): array
    {
