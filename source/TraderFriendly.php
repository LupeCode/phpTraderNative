...
class TraderFriendly
{
    ...
    {
        return Trader::ht_phasor($real, $inPhase);
    }
    ...
    {
        return Trader::ht_sine($real, $sine);
    }
    ...
    {
        return Trader::macdext($real, $fastPeriod, $fastMAType, $slowPeriod, $slowMAType, $signalPeriod);
    }
